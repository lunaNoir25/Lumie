...
You can add a feature of your chosing to better push Lumie into modern standards!
For ideas, look at the issues page, the discussions page, current limitations or online media.

(Or add comments yourself since I never do.)
...
You've probably seen this before, but it's very simple!

1. Fork the repository.
2. Create your branch, give it a descriptive name (ex: `bugfix: ()` or `feature: () command`).
3. Keep commits descriptive, like (most of) mine!
4. Open a pull request!

> [!Important]
> This is a solo-started project, so please be patient with PR reviews, I'm still going through school so I may not have much time.
